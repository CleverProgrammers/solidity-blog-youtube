const SideBar = () => (
  <ul className='main-nav-extended-list'>
    ...
    <li className='nav-item buttonable'>
      <div className='button-wrap--small notification'>
        <svg viewBox='0 0 24 24' className='button-icon fill-primary-text'>
          <g>
      ...
      <span className='text-large text-weight-medium pr-10'>Notifications</span>
    </li>
    ...
    <li className='nav-item buttonable'>
      ...
      <span className='text-large text-weight-medium pr-10'>Messages</span>
    </li>
    ...
    <li className='nav-item buttonable'>
      ...
      <span className='text-large text-weight-medium pr-10'>Lists</span>
    </li>
    ...
    <li className='nav-item buttonable'>
      ...
      <span className='text-large text-weight-medium pr-10'>Profile</span>
    </li>
    ...
    <li className='nav-item buttonable'>
      ...
      <span className='text-large text-weight-medium pr-10'>More</span>
    </li>
  </ul>
)
